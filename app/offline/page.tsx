  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-background px-6 text-foreground">
      <section className="max-w-lg text-center">
        ...
        <p className="mt-4 text-lg leading-8 text-muted-foreground">Teacher upload details saved on this device will be restored. Live data, AI, marketplace, publishing, and file transfer resume after you reconnect.</p>
