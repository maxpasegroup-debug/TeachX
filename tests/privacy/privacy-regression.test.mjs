...
test("public consent mutation is origin checked and rate limited",()=>{const route=read("app/api/privacy/consent/route.ts");assert.match(route,/rateLimit/);assert.match(route,/getPublicBaseUrl/);assert.match(route,/Invalid request origin/);});
