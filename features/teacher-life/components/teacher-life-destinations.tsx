...
function EarnMoreHub({ data }: { data: BusinessData }) {
  ...
  const nextAction = activeServices.length ? { label: "Manage My Services", href: "/teacher/business/services", detail: "Keep your offerings and plans current." } : { label: "Set up Teach 1:1", href: "/teacher/business/one-to-one", detail: "Start with the knowledge you already teach." };
