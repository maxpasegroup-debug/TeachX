  ...
  return <div className="space-y-8">
    <section className="rounded-[2rem] border border-indigo-100 bg-gradient-to-br from-indigo-50 via-white to-cyan-50 p-6 shadow-soft sm:p-8">
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_340px] lg:items-end">
        <div><p className="text-sm font-medium text-indigo-700">Welcome back, {firstName}</p><h1 className="mt-2 text-4xl font-semibold tracking-tight sm:text-5xl">Make today count.</h1><p className="mt-4 max-w-2xl text-lg leading-8 text-muted-foreground">Your classes, practice, goals, and next best learning step—all in one calm daily view.</p><div className="mt-7 flex flex-wrap gap-3"><Link className="rounded-2xl bg-indigo-600 px-6 py-3 font-medium text-white" href={data.home.continueLearning ? `/learning/${data.home.continueLearning.id}` : "/student/learn"}>Continue learning</Link><Link className="rounded-2xl border border-border bg-white px-6 py-3 font-medium" href="/student/ask-ai">Ask AI Tutor</Link></div><div className="mt-5 flex flex-wrap gap-2 text-sm"><Link className="rounded-xl border border-indigo-100 bg-white px-3 py-2 font-medium text-indigo-700 hover:bg-indigo-50" href="/student/search">Search learning</Link><Link className="rounded-xl border border-indigo-100 bg-white px-3 py-2 font-medium text-indigo-700 hover:bg-indigo-50" href="/student/notifications">Notifications</Link><Link className="rounded-xl border border-indigo-100 bg-white px-3 py-2 font-medium text-indigo-700 hover:bg-indigo-50" href="/student/timeline">Learning timeline</Link><Link className="rounded-xl border border-indigo-100 bg-white px-3 py-2 font-medium text-indigo-700 hover:bg-indigo-50" href="/student/files">Saved files</Link></div></div>
