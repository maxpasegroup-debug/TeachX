...
const quickLinks = [
  ...
  { label: "Teacher Marketplace", href: "/teacher/business/marketplace", group: "Pages", keywords: "marketplace profile bookings students requests", icon: Store },
  { label: "Teacher Wallet", href: "/teacher/business/wallet", group: "Commerce", keywords: "wallet earnings revenue sales ai credits", icon: Store },
  ...
  { label: "Create Lesson", href: "/teacher/ai-studio/create/lesson-generator", group: "Tools", keywords: "lesson resource create", icon: FileText },
  { label: "Create Worksheet", href: "/teacher/ai-studio/create/worksheet-generator", group: "Tools", keywords: "worksheet homework resource", icon: FileText },
  { label: "Question Paper", href: "/teacher/ai-studio/create/question-paper-builder", group: "Tools", keywords: "question paper exam", icon: FileText },
  { label: "My Resources", href: "/teacher/workspace/resources", group: "Resources", keywords: "files resources library", icon: LibraryBig },
