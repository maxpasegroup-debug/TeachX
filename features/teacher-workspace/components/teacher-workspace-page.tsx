...
export function TeacherWorkspacePage({ module, data }: { module: TeacherWorkspaceModule; data: WorkspaceData }) {
  ...
  return (
    <div className="space-y-6">
      <nav aria-label="Breadcrumb" className="text-sm text-muted-foreground"><Link className="hover:text-foreground" href="/teacher">Teacher Home</Link><span className="mx-2">/</span><Link className="hover:text-foreground" href="/teacher/life/save-time">Save Time</Link><span className="mx-2">/</span><span className="text-foreground">{copy.title}</span></nav>
