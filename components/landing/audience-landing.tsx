  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#fbfaf7] text-[#0b2230]">
      ...
      <section className="relative h-[calc(100svh-8rem)] min-h-[32.5rem] max-h-[52rem] overflow-hidden bg-[#071820]" aria-labelledby="public-hero-title">
        <Image alt="A professional teacher planning with a tablet in a bright classroom" className="hidden object-cover object-[61%_center] sm:block sm:object-[58%_center] lg:object-center" fill priority quality={60} sizes="(min-width: 640px) 100vw, 1px" src="/teacher-life-os-home.webp" />
