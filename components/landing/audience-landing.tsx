  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#fbfaf7] text-[#0b2230]">
      ...
      <section className="relative h-[calc(100svh-8rem)] min-h-[32.5rem] max-h-[52rem] overflow-hidden bg-[#071820]" aria-labelledby="public-hero-title">
        <Image alt="" aria-hidden="true" className="object-cover object-[61%_center] sm:object-[58%_center] lg:object-center" fetchPriority="low" fill loading="lazy" quality={60} sizes="100vw" src="/teacher-life-os-home.webp" />
