  ...
  return (
    <div aria-label="Privacy choices" aria-modal="true" className="fixed inset-x-0 bottom-0 z-[100] border-t border-border bg-background p-4 shadow-2xl" role="dialog">
      <div className="mx-auto max-w-5xl">
        <div className="flex items-start gap-4"><ShieldCheck className="mt-1 h-6 w-6 shrink-0 text-primary" /><div className="flex-1"><h2 className="text-lg font-semibold">Your privacy choices</h2><p className="mt-1 max-w-3xl text-sm leading-6 text-muted-foreground">Essential storage keeps TeachX secure and signed in. Optional functional, analytics, and marketing storage only runs with your choice. We honor Global Privacy Control.</p><Link className="mt-2 inline-block text-sm font-medium text-primary underline" href="/cookies">Cookie policy</Link></div></div>
